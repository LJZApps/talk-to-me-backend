...
use App\Repository\UserMessagePolicyRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: UserMessagePolicyRepository::class)]
class UserMessagePolicy
{
    ...
    #[ORM\Column]
    private ?bool $allow_everyone = null;

    #[ORM\Column]
    private ?bool $allow_only_friends = null;
